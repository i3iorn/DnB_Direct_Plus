...
from src.exceptions import CSVExportError, FlattenerError
...
class Transformer:
    ...
    def export_to_csv(self, file_path: str, include_headers: bool = True, delimiter: str = ',',
                      flattener_options: dict = None, overwrite: bool = False, keys_to_write: List[str] = None) -> None:
        """
        ...
        try:
            flattened_data = self.process_data(flattener_options)
